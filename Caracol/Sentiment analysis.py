...
data = pd.DataFrame(columns=['noticiero', 'año', 'mes', 'dia','idAudio', 'clasificacion', 'score', 'subjetividad',
                             'palabraFrecuente', 'frecuenciaPalabra', 'negativeScore'])
noticiero = "Caracol"
...
def store_result(annotations, año, mes, dia, frecuencias, id_audio):
    ...
    print(
        "Overall Sentiment: score of {} with n_score of {}".format(score, n_score)
    )
